...
SRC_URI = "${ATF_SRC};branch=${SRCBRANCH} \
	${@bb.utils.contains('MACHINE_FEATURES', 'optee', bb.utils.contains('MACHINE', 'imx8qm-iwg27m', 'file://imx_atf_support_iwg27m.patch file://imx_atf_4gb_lpddr4_optee_support_iwg27m.patch', 'file://imx_atf_support_iwg27m.patch', d), '', d)}"
